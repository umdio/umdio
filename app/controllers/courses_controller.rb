      ...
      module Courses
        def self.registered(app)
          ...
          app.namespace '/v1/courses' do
            ...
            get '/list' do
              json(Course.list_sem(request.params['semester'])).map(&:to_v1_info)
            end
            ...
            get '/:course_id/sections/:section_id' do
              ...
              sections = (find_sections request.params['semester'], section_ids).map(&:to_v1)
          ...
          app.get '/v0/courses/list' do
            json(Course.list_sem(request.params['semester'])).map(&:to_v0_info)
          end
          ...
          app.get '/v0/courses/:course_id/sections/:section_id' do
            ...
            sections = (find_sections request.params['semester'], section_ids).map(&:to_v0)
